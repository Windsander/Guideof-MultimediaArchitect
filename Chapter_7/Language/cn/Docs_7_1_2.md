...
上一节的四个困境里，MP4 对 "索引" 这一题给出了教科书级的解法。我们日常见到的 `.mp4` 文件，规范血统可以追溯到两条线：Apple 在 2001 年公开的 **QuickTime 文件格式（QTFF）** [\[4\]][ref]，以及以此为母体演进而来的国际标准 **ISO BMFF（ISO/IEC 14496-12）**，后者正是 MP4、3GP、CMAF 乃至 fMP4 的共同底座 [\[5\]][ref]。两份文档的术语几乎一一对应（QTFF 叫 Atom，ISO BMFF 叫 Box），下文统称为 Box。
