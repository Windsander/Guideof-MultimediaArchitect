...
握手解决的是 "你是谁、版本几、线路通不通"。门一推开，真正的主角才登场：握手完成后的 RTMP 连接，开始在一条 TCP 上 **多路复用若干条 Chunk 流**——音视频、命令、控制消息挤在同一根管道里，大消息切片让路，小消息见缝插针 [\[1\]][ref]。这套切分机制是 RTMP 全部灵活性的来源，也是下一节的主题。
