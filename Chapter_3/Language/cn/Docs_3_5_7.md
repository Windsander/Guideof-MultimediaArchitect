...
# 3.5.7 颜色三要素色彩空间（HSL [HSV / HSI / HSL（Lightness）]）
...
<figure>
   ...
   <figcaption>
      <p>图 3.5.7-1 乔治·瓦伦西（Georges Valensi）于 1945 年在美专利局注册手稿 <a href="References_3.md">[15]</a></p>
   </figcaption>
</figure>
</center>
...
<figure>
   ...
   <figcaption>
      <p>图 3.5.7-2 RGB 色彩空间投影建立 HSL 色度平面（HSL Chromaticity Plane）示意图</p>
   </figcaption>
</figure>
</center>
...
<figure>
   ...
   <figcaption>
      <p>图 3.5.7-3 HSL 色度平面（HSL Chromaticity Plane）示意图</p>
   </figcaption>
</figure>
</center>
...
<figure>
   ...
   <figcaption>
      <p>图 3.5.7-4 HSL 色度平面（HSL Chromaticity Plane）连续性处理拓扑示意图</p>
   </figcaption>
</figure>
</center>
