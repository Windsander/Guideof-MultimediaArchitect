...
图 5-15 上半部分的基频轨道，几乎与 440Hz 参考线重合。下半部分的色度热力图更有意思：**A 音级上横贯着一条明亮主带**——无论换哪件乐器演奏，响的都是 A4。而 E 音级（A 的纯五度，见 **[1.4.1](../../../Chapter_1/Language/cn/Docs_1_4_1.md)**）的次级亮带，则来自各乐器泛音列中的五度泛音成分。这正是色度特征 "折叠八度、直指音名" 的能力体现。
