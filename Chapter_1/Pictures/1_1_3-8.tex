...
\newcounter{x} \newcounter{y}
{
    ...
    % Draw inputs
    \foreach \y / \idx in {0/000, 1/000, 2/010, 3/011, 4/100, 5/101, 6/110, 7/111}
        \node[n, pin={[pin edge={latex'-,black}]left:$f(\idx)$}]
              (N-0-\y) at (0,-\y) {};
    % Draw outputs
    \foreach \y / \idx in {0/000, 1/010, 2/100, 3/110, 4/001, 5/011, 6/101, 7/111}
        \node[n, pin={[pin edge={-latex',black}]right:$f(\idx)$}]
              (N-2-\y) at (0.8,-\y) {};

    \foreach \y / \idx in {0/000, 1/100, 2/010, 3/110, 4/001, 5/101, 6/011, 7/111}
        \node[n, pin={[pin edge={-latex',black}]right:$f(\idx)$}]
              (N-4-\y) at (3,-\y) {};
