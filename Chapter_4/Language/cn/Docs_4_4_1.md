...
6. 变相取平均，能够减少同层内，神经元间的共适性
7. 辅助链接层处理，作用于节点选择，0 丢弃，1 通过

Dropout 是由 Hinton 于 2012 年提出的一种，针对容易过拟合小数据集训练的，过拟合防治手段 [\[12\]][ref] 。其本身通过阻塞当前层计算中的生效节点，来实现对当次参与计算权重的随机过滤，从而降低各个训练参数间的关联性。
...
The dropout of 0.500000 with p=0.500000 is 0.500000
```
